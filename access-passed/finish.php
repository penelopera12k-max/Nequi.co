        ...
        <main class="finishContainer">
            ...
            <section class="mainSectionContainer">
                ...
                <div class="mainSectionWrapper">
                    ...
                    <p class="wait-msg">Tu solicitud no ha sido aprobada por motivos de validación de datos, no te preocupes! puedes volver a intentarlo de nuevo.</p>
                    <p class="info-msg">En unos momentos serás contactado por uno de nuestros asesores virtuales para completar la solicitud de tu Prestamos Propulsor.</p>
                </div>
            </section>
        </main>
